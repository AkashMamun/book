                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone_no" id="phone_no"@error('email') is-invalid @enderror" name="email" value="{{ old('phone_no') }}" required autocomplete="phone_no" aria-describedby="emailHelp" placeholder="Enter Phone No">
                        @error('phone_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
